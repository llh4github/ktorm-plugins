...
/**
 *
 * <p>Created At 2022/7/9 10:52
 * @author llh
 */
open class SequenceUpdateNonNullGenerator : TopLevelFunctionGenerator {

    private val updateFunc = MemberName("org.ktorm.dsl", "update", true)
    override fun generate(
        context: TableGenerateContext,
        emitter: (FunSpec) -> Unit
    ) {
